(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd00","3","81","257","878",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_binddataset("board_menu");
            obj.set_treeinitstatus("expand,all");
            obj.set_treeusecheckbox("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"237\"/></Columns><Rows><Row size=\"24\"/></Rows><Band id=\"body\"><Cell text=\"bind:MENU_NAME\" edittype=\"tree\" displaytype=\"treeitemcontrol\" treelevel=\"bind:MENU_LEVEL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",260,958,this,function(p){});
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.grd00.addEventHandler("oncelldblclick",this.Grid00_oncelldblclick,this);
        };
